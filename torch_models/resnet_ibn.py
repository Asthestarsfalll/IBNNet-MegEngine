...
def resnet18_ibn_a(pretrained=False, **kwargs):
    ...
    if pretrained:
        model.load_state_dict(torch.hub.load_state_dict_from_url(
            model_urls['resnet18_ibn_a'], map_location='cpu'))
    return model
...
def resnet34_ibn_a(pretrained=False, **kwargs):
    ...
    if pretrained:
        model.load_state_dict(torch.hub.load_state_dict_from_url(
            model_urls['resnet34_ibn_a'], map_location='cpu'))
    return model
...
def resnet101_ibn_a(pretrained=False, **kwargs):
    ...
    if pretrained:
        model.load_state_dict(torch.hub.load_state_dict_from_url(
            model_urls['resnet101_ibn_a'], map_location='cpu'))
    return model
...
def resnet18_ibn_b(pretrained=False, **kwargs):
    ...
    if pretrained:
        model.load_state_dict(torch.hub.load_state_dict_from_url(
            model_urls['resnet18_ibn_b'], map_location='cpu'))
    return model
...
def resnet34_ibn_b(pretrained=False, **kwargs):
    ...
    if pretrained:
        model.load_state_dict(torch.hub.load_state_dict_from_url(
            model_urls['resnet34_ibn_b'], map_location='cpu'))
    return model
...
def resnet50_ibn_b(pretrained=False, **kwargs):
    ...
    if pretrained:
        model.load_state_dict(torch.hub.load_state_dict_from_url(
            model_urls['resnet50_ibn_b'], map_location='cpu'))
    return model
...
def resnet101_ibn_b(pretrained=False, **kwargs):
    ...
    if pretrained:
        model.load_state_dict(torch.hub.load_state_dict_from_url(
            model_urls['resnet101_ibn_b'], map_location='cpu'))
    return model
